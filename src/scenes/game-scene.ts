...
import marioFire from '../objects/marioFire';
...
export class GameScene extends Phaser.Scene {
  ...
  private bosss: Phaser.GameObjects.Group;
  private meteorites: Phaser.GameObjects.Group;
  private platforms: Phaser.GameObjects.Group;
  private playerFire: Phaser.GameObjects.Group;
  public player: Mario;
  ...
  create(): void {
    ...
    this.playerFire = this.player.playerFire;
    // // *****************************************************************
    // // COLLIDERS
    // // *****************************************************************
    ...
    this.physics.add.collider(this.player, this.meteorites,()=>{this.player.gotHit()});
    ...
    if (
      ...
      (_player.getKeys().get('RIGHT').isDown &&
        ...
        if(_portal.name.slice(0, 6) == (this.registry.get('level'))){
          ...
          //   this.player.setX(_portal.getPortalDestination().x);
          //   this.player.setY(_portal.getPortalDestination().y);
          //   this.inProcess = false;
          // }, [], this);
          }
        }
  ...
  private handlePlayerCollectiblesOverlap(
    ...
    switch (_collectible.texture.key) {
      ...
      case 'flash': {
        this.player.inProcessFlash = true;
        this.time.delayedCall(5000, ()=>{ 
        this.player.inProcessFlash = false;
        }, [], this);
        break;
      }
      default: {
